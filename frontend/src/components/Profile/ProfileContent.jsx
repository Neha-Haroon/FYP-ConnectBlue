        ...
        <>
          <div className="flex justify-center w-full">
            <div className="relative">
              <img
                src={`${user?.avatar?.url}`}
                className="w-[150px] h-[150px] rounded-full object-cover border-[7px] border-[#3284d1]"
                alt=""
              />
          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} aria-required={true}>
              ...
              <input
                className={`w-[250px] h-[40px] border bg-blue-700 text-center text-[#a5c9e7eb] rounded-[3px] mt-8 cursor-pointer`}
                required
