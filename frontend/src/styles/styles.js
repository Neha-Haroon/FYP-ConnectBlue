const styles = {
  ...
  serviceTitle: "text-[25px] font-[600] font-Roboto text-[#333]",
  serviceDiscountPrice: "font-bold text-[18px] text-[#333] font-Roboto",
  price: "font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through",
  shop_name: "pt-3 text-[15px] text-blue-400 pb-3",
  active_indicator:
    "absolute bottom-[-27%] left-0 h-[3px] w-full bg-blue-600 hover:bg-blue-700",
  button:
